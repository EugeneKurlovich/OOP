...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral("images.jpg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        pushButton_2->setMinimumSize(QSize(10, 0));
    ...
    {
        MainWindow->setWindowTitle(QApplication::translate("MainWindow", "TextEditor", 0));
